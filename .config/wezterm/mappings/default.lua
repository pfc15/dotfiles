...
local mappings = {
  ...
  { "<C-Tab>", act.ActivateTabRelative(-1), "prev tab" },
  { "<M-CR>", act.ToggleFullScreen, "fullscreen" },
  { "<C-S-c>", act.CopyTo "Clipboard", "copy" },
  { "<C-S-v>", act.PasteFrom "Clipboard", "paste" },
  { "<C-f>", act.Search "CurrentSelectionOrEmptyString", "search" },
  { "<C-k>", act.ClearScrollback "ScrollbackOnly", "clear scrollback" },
  { "<C-l>", act.ShowDebugOverlay, "debug overlay" },
  { "<C-n>", act.SpawnWindow, "new window" },
  { "<C-p>", act.ActivateCommandPalette, "command palette" },
  { "<C-r>", act.ReloadConfiguration, "reload config" },
  ...
  { "<C-w>", act.CloseCurrentTab { confirm = true }, "close tab" },
  { "<C-z>", act.TogglePaneZoomState, "toggle zoom" },
  { "<PageUp>", act.ScrollByPage(-1), "" },
  { "<PageDown>", act.ScrollByPage(1), "" },
  { "<C-Insert>", act.PasteFrom "PrimarySelection", "" },
  { "<C-Insert>", act.CopyTo "PrimarySelection", "" },
  { "<C-Space>", act.QuickSelect, "quick select" },
  {
    "<S-M-t>",
  ...
  ---quick split and nav
  { '<C-">', act.SplitHorizontal { domain = "CurrentPaneDomain" }, "vsplit" },
  { "<C-%>", act.SplitVertical { domain = "CurrentPaneDomain" }, "hsplit" },
